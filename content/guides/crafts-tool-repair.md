...
A sharp, sound tool does more work with less effort and is *safer* than a dull
...
The principle is the same for knives, axes, chisels, and many garden tools: grind
the edge at a consistent angle until it's keen, then remove the burr.
...
- **Loose tool head (axe, hammer, hoe):** dry the handle, reseat the head, and
  drive a wooden or metal **wedge** into the handle's end to swell it tight in
  the eye. Soaking a slightly loose head briefly can swell wood as a stop-gap.
- **Cracked handle:** replace it. Carve a new handle from straight, seasoned
  hardwood to fit the eye snugly.
- **Rust:** scrub off with sand, ash, or an abrasive; then oil the metal.
