...
Protein is the part of a plant-based diet that needs a little thought —
...
## The main plant proteins

- **Legumes:** beans, lentils, split peas, chickpeas, peanuts — the protein
  backbone, cheap and storable.
- **Grains:** wheat, rice, oats, millet, maize — protein plus energy.
- **Nuts and seeds:** sunflower, pumpkin, sesame, hemp, and tree nuts — protein
  and valuable fats.
- **Soy** (if available): tofu, tempeh, and soy milk are especially rich.

## Combine for complete protein

Legumes and grains complement each other — together they cover the amino acids
each lacks alone. You don't need them in the same mouthful, just across the day.
Classic pairings that work everywhere:

- Beans with rice or maize
- Lentils with bread or flatbread
- Hummus (chickpeas + sesame) with bread
- Peanut sauce with grains
...
A plant-based diet also needs attention to a few nutrients: iron and zinc (from
legumes, seeds, wholegrains — eat with something sour/vitamin-C rich to absorb
