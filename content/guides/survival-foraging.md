...
Wild food can extend your supplies, but a single wrong plant or mushroom can kill.
...
- It is far safer to know **five** wild foods with total certainty than to guess
  at fifty. Learn each by all its features in every season, and from someone who
  knows your local area.
- Learn the **dangerous lookalikes** for every food plant — many deadly plants
  closely resemble safe ones.

## Avoid the obvious dangers

Skip anything with:

- Milky or coloured sap (white latex), unless you know it's safe.
- A bitter, soapy, or almond smell.
- Three-leaf growth patterns (poison ivy/oak), fine hairs, spines, or thorns you
  can't identify.
- Beans, bulbs, or seeds in pods you don't recognise.
