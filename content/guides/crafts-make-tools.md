...
> gently before trusting it.

## Start with the four basics

Most work needs only a few tool types:

- **A cutting edge** — knife, scraper, or chopper.
- **A point** — for digging, drilling, or piercing.
- **A striker** — a mallet or hammer for driving and pounding.
- **A handle** — what turns any of the above into a usable tool.

## Make a cutting edge

- **From salvage metal:** an old file, leaf spring, or steel strip can be ground to
  an edge on a stone. Salvaged metal is the strongest, longest-lasting blade you can
  make.
...
- **A wooden mallet** (a "maul") is just a dense hardwood billet with a carved
  handle — good for driving stakes, splitting with a wedge, and gentle pounding.
- **A stone hammer** is a rounded stone hafted like the tool above, or simply held
  in the hand for rough work.

## Make digging and pointed tools

- **A digging stick** — a straight hardwood shaft with a fire-hardened, sharpened
  point — digs roots, post holes, and trenches.
